...
class Detail_model extends CI_Model
{
	...
	{
		$this->db->select('tbl_jadwal.*, tbl_pengadilan.*, tbl_periode.*');
	...
	public function update_temuan($post)
	{
		$this->db->set('dok_temuan', $post['temuan']);
		$this->db->where('id_jadwal', $post['id_jadwal']);
		return $this->db->update('tbl_jadwal');
	}

	public function update_lhp($post)
	{
		$this->db->set('dok_lhp', $post['lhp']);
		$this->db->where('id_jadwal', $post['id_jadwal']);
		return $this->db->update('tbl_jadwal');
	}

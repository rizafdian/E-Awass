                  ...
                  <table class="table m-0">
                    ...
                    <tbody>
                     <?php $i = 0; foreach ($subarea as $subareas): ?>
                      <tr>
                        <td><a href="<?php echo site_url('Wasbid/Periksa/eviden/'.$subareas->id_subobjek.'/'.$jadwal->id_jadwal) ?>" target="_blank"><?=$subareas->nama ?></a></td>     
                        <td>  <?php if ($eviden[$i] == 1): ?>
                        ...
                        <td>
                          <a href="<?php echo site_url('Wasbid/Periksa/eviden/'.$subareas->id_subobjek.'/'.$jadwal->id_jadwal) ?>" class="text-muted text-center">

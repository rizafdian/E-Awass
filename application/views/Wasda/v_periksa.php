            ...
            <div class="card">
              <div class="card-header border-transparent">
                ...
                <div class="card-tools">
                  <a type="button" class="btn btn-dark btn-sm" href="<?php echo site_url('Wasda/periksatemuan/pdfmake/'.$area->id.'/'.$jadwal->id_jadwal) ?>" target="_blank"><i class="fa fa-file-pdf"></i>  PDF</a>
                  ...
                  <table class="table m-0">
                    ...
                    <tbody>
                     <?php $i = 0; foreach ($subarea as $subareas): ?>
                      <tr>
                        <td><a href="<?php echo site_url('Wasda/Periksatemuan/subarea/'.$subareas->id_subobjek.'/'.$jadwal->id_jadwal) ?>" target="_blank"><?=$subareas->nama ?></a></td>     
                        <td>
                                <?php if ($eviden[$i] == 1): ?>
                        ...
                        <td>
                          <a href="<?php echo site_url('Wasda/Periksatemuan/subarea/'.$subareas->id_subobjek.'/'.$jadwal->id_jadwal) ?>" class="text-muted text-center">

    <div class="content-header">
      <div class="container">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0"><small>Detail Pengawasan</small></h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
    ...
    <div class="content">
      <div class="container">
        <div class="row">
          ...
          <div class="col-lg-8">
             <a class="btn btn-app bg-danger" href="<?php echo site_url('Wasda/Temuan/index/'.$jadwal->id_jadwal) ?>">
            ...
            <a class="btn btn-app bg-dark" href="<?php echo site_url('Wasda/History/index/'.$jadwal->id_pengadilan.'/'.$jadwal->id_jadwal) ?>">
                    ...
                    <table class="table m-0">
                      ...
                      <tbody>
                       <?php $i = 0; foreach ($area as $areas): ?>
                        <tr>
                          <td><a href="<?php echo site_url('Wasda/Periksatemuan/index/'.$areas->id.'/'.$jadwal->id_jadwal) ?>"><?=$areas->nama ?></a>    
                          </td>
                          ...
                          <td>
                            <a href="<?php echo site_url('Wasda/Periksatemuan/index/'.$areas->id.'/'.$jadwal->id_jadwal) ?>" class="text-muted text-center">
...
<div class="modal fade" id="modaltemuan<?=$jadwal->id_jadwal ?>" style="display: none;" aria-hidden="true">
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      ...
      <form action="<?php echo site_url('Wasda/detail/uploadtemuan/'.$jadwal->id_jadwal) ?>" method="post" enctype="multipart/form-data" role="form">
...
<div class="modal fade" id="modallhp<?=$jadwal->id_jadwal ?>" style="display: none;" aria-hidden="true">
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      ...
      <form action="<?php echo site_url('Wasda/detail/uploadlhp/'.$jadwal->id_jadwal) ?>" method="post" enctype="multipart/form-data" role="form">
        <div class="modal-body">
          <input type="hidden" name="id_jadwal" value="<?php  echo $jadwal->id_jadwal ?>">
          <div class="form-group">
                    <label for="exampleInputFile">File input</label>
...
<!-- akhir modal upload lhp -->

<!-- modal download lhp -->
<div class="modal fade" id="doc_lhp" style="display: none;" aria-hidden="true">
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      <div class="modal-header">
        <h4 class="modal-title">Download Laporan Hasil Pemeriksaan</h4>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">×</span>
        </button>
      </div>    
      <div class="card">
        <div class="card-header">
          <h3 class="card-title">Klik tombol di bawah untuk download LHP</h3>
        </div>
        <div class="card-body row">
                <div class="col-md-6">
                  <a type="button" href="<?php echo site_url('Wasda/Detail/lhp/'.$jadwal->id_jadwal) ?>" class="btn btn-warning btn-block"><i class="fa fa-download"></i> BAB I-II</a>
                </div>
                <div class="col-md-6">
                  <a type="button" href="<?php echo site_url('Wasda/Detail/bab_3/'.$jadwal->id_jadwal) ?>" target="_blank" class="btn btn-warning btn-block"><i class="fa fa-download"></i> BAB III</a>
                </div>
              </div>

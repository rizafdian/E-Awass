                ...
                <input type="hidden" name="id_jadwal" value="<?php  echo $jadwal->id_jadwal ?>">
                  ...
                  <div class="card-body">
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-sm-10">
                        <textarea rows='8' name="kondisi" type="textarea" class="form-control" id="kondisi" placeholder="Masukan temuan"></textarea>
                      </div>
                    </div>
                    <div class="form-group row">
                       <label for="kriteria" class="col-sm-2 col-form-label">Kriteria</label>
                        <div class="col-sm-10">
                          <textarea rows='4' name="kriteria" type="textarea" class="form-control" id="kriteria" placeholder="Masukan kriteria"></textarea>
                        </div>
                    </div>
                    <div class="form-group row">

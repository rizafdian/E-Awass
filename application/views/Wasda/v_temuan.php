            ...
            <div class="card">
              <div class="card-header border-transparent">
                <div class="card-tools">
                  <a type="button" class="btn btn-dark btn-sm" href="<?php echo site_url('Wasda/temuan/pdfmake/'.$jadwal->id_jadwal) ?>" target="_blank"><i class="fa fa-file-pdf"></i>  PDF</a>
                        ...
                        <?php if ($subareas->id_objek == $areas->id): ?>
                          <?php $number = 1; foreach ($temuan as $temuans) : ?>
                            <?php if ($temuans->id_subobjek == $subareas->id_subobjek): ?>
                              ...
                              <?php endif; ?>  
                              <tr>
                                <td width="5%" align="center"><?= $nmr_temuan++ ?></td>
                                <?php $number++; ?>
                                <td colspan="4">
                                  <b>Kondisi :</b> <br>

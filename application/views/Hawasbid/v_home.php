        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item active"><a href="<?php echo site_url('hawasbid') ?>">Home</a></li>
            </ol>
          </div>
        </div>
      </div>
                    ...
                    <tbody>
                     <?php foreach ($jadwal as $jadwals): ?>
                      <tr>
                        ...
                        <td>
                          <a href="<?php echo site_url('Hawasbid/Detail/index/'.$jadwals->id_jadwal) ?>" class="text-muted">

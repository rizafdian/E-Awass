            ...
            <div class="card">
              <div class="card-header border-transparent">
                <div class="card-tools">
                  <a type="button" class="btn btn-dark btn-sm" href="<?php echo site_url('Hawasbid/Tindaklanjut/pdfmake/'.$jadwal->id_jadwal) ?>" target="_blank"><i class="fa fa-file-pdf"></i>  PDF</a>

            ...
            <div class="card">
              <div class="card-header border-transparent">
                ...
                <div class="card-tools">
                  <a type="button" class="btn-sm bg-info" href="<?php echo site_url('Hawasbid/Periksatemuan/index/'.$subobjek->id_objek.'/'.$jadwal->id_jadwal) ?>">
              ...
              <div class="card-body p-0">
                <div class="card">
                  <div class="card-body">
                    ...
                    <?php endif; ?>
                    <a type="button" href="<?php echo site_url('Hawasbid/Periksatemuan/formTambah/'.$subobjek->id_subobjek.'/'.$jadwal->id_jadwal) ?>">
                    ...
                    <?php $no = 1; ?>
                      ...
                      <tr>
                        ...
                        <td>
                          <dl>
                            <dt>Kondisi</dt>
                              <dd><?= $temuans->kondisi ?></dd>
                            <dt>Kriteria</dt>
                              <dd><?= $temuans->kriteria ?></dd>
                            <dt>Sebab</dt>
                              <dd><?= $temuans->sebab ?></dd>
                            <dt>Akibat</dt>
                              <dd><?= $temuans->akibat ?></dd>
                            <dt>Rekomendasi</dt>
                              <dd><?= $temuans->rekomendasi ?></dd>
                          </dl>
                        </td>
                        <td>
                          <a href="<?php echo site_url('Hawasbid/Periksatemuan/formEdit/'.$temuans->id_subobjek.'/'.$temuans->id_jadwal.'/'.$temuans->id_temuan) ?>" ><span class="badge bg-warning"><i class="fa fa-edit"></i> Edit</span> </a> 
                          <a onclick="deleteConfirm('<?php echo site_url('Hawasbid/Periksatemuan/delete/'.$temuans->id_subobjek.'/'.$temuans->id_jadwal.'/'.$temuans->id_temuan) ?>')"

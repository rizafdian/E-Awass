                ...
                <input type="hidden" name="id_temuan" value="<?php  echo $temuan->id_temuan ?>">
                  ...
                  <div class="card-body">
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-sm-10">
                        <textarea name="kondisi" type="textarea" class="form-control" id="kondisi" placeholder="Masukan temuan"><?php echo $temuan->kondisi; ?></textarea>
                      </div>
                    </div>
                    <div class="form-group row">
                       <label for="kriteria" class="col-sm-2 col-form-label">Kriteria</label>
                        <div class="col-sm-10">
                          <textarea name="kriteria" type="textarea" class="form-control" id="kriteria" placeholder="Masukan kriteria"><?php echo $temuan->kriteria; ?></textarea>
                        </div>
                    </div>
                    <div class="form-group row">

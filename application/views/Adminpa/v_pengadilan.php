              ...
              <table class="table table-bordered">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td><a href="<?php echo site_url('Adminpa/pengadilan/edit/'.$pengadilans->id) ?>"><span class="badge bg-warning"><i class="fas fa-edit"></i> Edit</span> </a>
                        <a onclick="deleteConfirm('<?php echo site_url('Adminpa/pengadilan/delete/'.$pengadilans->id) ?>')"

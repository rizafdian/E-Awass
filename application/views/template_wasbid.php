  ...
  <nav class="main-header navbar navbar-expand-md navbar-light navbar-white">
    <div class="container">
      ...
      <div class="collapse navbar-collapse order-3" id="navbarCollapse">
        ...
        <ul class="navbar-nav">
          <li class="nav-item">
            <a href="<?php echo site_url('hawasbid') ?>" class="nav-link">Home</a>
          </li>
          <li class="nav-item dropdown">
            ...
            <ul aria-labelledby="dropdownSubMenu1" class="dropdown-menu border-0 shadow">
              <li><a href="<?php echo site_url('Hawasbid/Profile/index/') ?>" class="dropdown-item">Profil </a></li>
              <li><a href="<?php echo site_url('Hawasbid/Profile/pass/') ?>" class="dropdown-item">Reset Password</a></li>

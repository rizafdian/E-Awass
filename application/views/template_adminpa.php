		...
		<aside class="main-sidebar sidebar-dark-primary elevation-4">
			...
			<div class="sidebar">
               ...
               with font-awesome or any other icon font library -->
						...
						<li class="nav-item">
							<a href="<?php echo site_url('Adminpa/Jadwal/') ?>" class="nav-link">
						...
						<li class="nav-item">
							<a href="<?php echo site_url('Adminpa/Pengadilan/') ?>" class="nav-link">
						...
						<li class="nav-item">
							<a href="<?php echo site_url('Adminpa/Tim/') ?>" class="nav-link">
						...
						<li class="nav-item">
							<a href="<?php echo site_url('Adminpa/User/') ?>" class="nav-link">

          ...
          <div class="col-12">
            ...
            <div class="card">
              <div class="card-header">
                <a href="<?php echo site_url('Superadmin/Jadwal/add') ?>"><i class="fas fa-plus"></i> Tambah</a>
              </div>
            <div class="card-body">
              <table class="table table-bordered">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td><a href="<?php echo site_url('Superadmin/jadwal/edit/'.$jadwals->id_jadwal) ?>"><span class="badge bg-warning"><i class="fas fa-edit"></i> Edit</span> </a>
                        <a href="#" onclick="deleteConfirm('<?php echo site_url('Superadmin/jadwal/delete/'.$jadwals->id_jadwal) ?>')"

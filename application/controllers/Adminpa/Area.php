...
class Area extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $this->template->load('template_adminpa', 'Admin/v_area',  $data);
    }
    ...
    public function add()
    {
        ...
        $this->template->load('template_adminpa', 'Admin/v_area_tambah', $data);
    }
    ...
    public function edit($id = null)
    {
        ...
        $this->template->load('template_adminpa', 'Admin/v_area_edit', $data);

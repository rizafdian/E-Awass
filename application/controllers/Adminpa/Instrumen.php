...
class Instrumen extends CI_Controller
{
    public function __construct()
    {
        ...
        $this->load->model("Admin/instrumen_model");
    ...
    public function index()
    {
        ...
        $this->template->load('template_adminpa', 'Admin/v_instrumen',  $data);
    }
    ...
    public function add()
    {
        ...
        $this->template->load('template_adminpa', 'Admin/v_instrumen_tambah', $data);
    }
    ...
    public function edit($id = null)
    {
        ...
        $this->template->load('template_adminpa', 'Admin/v_instrumen_edit', $data);
    }

...
class Profile extends CI_Controller{
	...
	function __construct(){
		...
		parent::__construct();
		$this->load->model('Wasbid/profile_model');
	...
	function index(){
		...
		$this->template->load('template_pegawai', 'Wasbid/v_profile', $data);
	}
	...
	function Pass()
	{
		...
		$data['user'] = $this->profile_model->getById($id_user);
		$data['pengadilan'] = $this->profile_model->getPengadilan();
		$this->template->load('template_pegawai', 'Wasbid/v_edit_pass', $data);
	}
}